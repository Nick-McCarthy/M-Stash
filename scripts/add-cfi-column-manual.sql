-- Manual Migration: Add CFI column to ebook_bookmarks table
-- This script properly handles the missing column by using NULL
...
-- Note: We don't select "cfi" from the old table since it doesn't exist
